...
$sql = "SELECT id, image, name,  description, stock, category, price FROM product WHERE category = 'drink'";
...
<head>
  ...
  <title>Peri Palace - Drinks Menu</title>
  <style>
    ...
    <section class="section mains text-center" id="drinks">
      <div class="container">
        ...
        <p class="section-subtitle label-2">
          Raise Your Spirits with Our Refreshing Mojitos - Crafted to Quench, Delight, and Refresh!
        </p>
                ...
                <div class="card-content">
                  ...
                  <div class="btn-group">
                    ...
                    <form method="POST" action="removefrommenu.php">
                      <input type="hidden" name="name" value="' . htmlspecialchars($row["name"]) . '">
                      <input type="hidden" name="url" value="drinks.php">
                      <button class="btn btn-primary" type="submit" name="removefrommenu">Remove</button>
                    </form>
